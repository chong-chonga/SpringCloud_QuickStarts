...
public class UserController {
    ...
    public ApiResult<UserDTO> getUserInfo(@PathVariable(value = "userId") @Positive Long userId) throws InterruptedException {
    ...
    public Object dis() {
        List<ServiceInstance> instances = discoveryClient.getInstances("SERVICE-PROVIDER-PAYMENT");
